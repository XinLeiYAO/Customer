...
public class RecommendAdapter extends SingleBaseAdapter<RecommendBean.BodyBean, RecommendAdapter.ViewHoider> {
    public RecommendAdapter(Context context, List<RecommendBean.BodyBean> datas) {
        super(context, datas);
    }
    ...
    @Override
    public void onBindView(int position, RecommendBean.BodyBean data, ViewHoider holder) {
