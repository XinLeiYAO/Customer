...
public class JieGouTuNewAdapter extends RecyclerView.Adapter<JieGouTuNewAdapter.ViewHolder> {
    private Context context;
    private List<QuanBuBean.BodyBean> list;
    public KeHuHomeLiangFangAdapter.ListDataCallBack listDataCallBack;

    public JieGouTuNewAdapter(Context context, List<QuanBuBean.BodyBean> list) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private RelativeLayout kehuHomeLiangfangLin, lookmore;
        ...
        public ViewHolder(View itemView) {
            ...
            lookmore = (RelativeLayout) itemView.findViewById(R.id.lookmore_layout);
